    ...
    <div className="h-20 bg-white/50 dark:bg-[#0B1121]/50 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50 flex items-center justify-between px-8 sticky top-0 z-20 font-sans">
      ...
      <div className="relative group flex items-center">
        ...
        <button 
          ...
          aria-haspopup="true"
          className="flex items-center gap-2 bg-white dark:bg-[#121316] border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 shadow-sm p-2 rounded-full transition-all cursor-pointer"
        >
