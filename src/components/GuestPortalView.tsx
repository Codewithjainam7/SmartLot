...
export function GuestPortalView({ workOrder, onSubmitCompletion, onBack }: GuestPortalViewProps) {
  ...
  return (
    <div className="flex-1 p-4 md:p-8 overflow-y-auto h-full bg-[#121316] text-white flex flex-col items-center justify-start">
      ...
      <div className="w-full max-w-md flex items-center justify-between py-4 mb-4 border-b border-white/10">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D8F235]/10 text-[#D8F235] text-[10px] font-extrabold uppercase">
      ...
      <div className="w-full max-w-md bg-[#1E2026] rounded-3xl p-6 border border-white/10 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
            ...
            <div className="text-lg font-black text-[#D8F235] flex items-center gap-1 mt-1">
        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit} className="space-y-4 pt-2 border-t border-white/10">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              <Camera size={16} className="text-[#8B8CF8]" /> Upload Completion Proof
            </h3>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 text-white font-bold text-sm outline-none focus:border-[#D8F235]"
              />
            </div>
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/10 p-3 rounded-2xl flex items-center justify-between text-xs text-gray-300">
                <span className="flex items-center gap-2 font-medium">
                  <FileText size={16} className="text-[#8B8CF8]" /> Invoice_SP10482_WO.pdf
                </span>
                <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/20 px-2 py-0.5 rounded-full">Ready</span>
              </div>
            </div>

            <button
              type="submit"
              className="w-full bg-[#D8F235] hover:bg-[#c4db30] text-[#121316] rounded-2xl py-4 font-black text-sm flex items-center justify-center gap-2 shadow-lg transition-all"
            >
