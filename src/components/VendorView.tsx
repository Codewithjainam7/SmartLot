...
export function VendorView({ 
  ...
  return (
    <div className="flex-1 p-4 md:p-8 space-y-6 overflow-y-auto h-full bg-[#F4F6F9] dark:bg-[#0B1121] text-gray-900 dark:text-gray-100">
      
      {/* Top Header Card */}
      <div className="bg-white dark:bg-[#0d1117] rounded-3xl p-6 md:p-8 border border-gray-200 dark:border-white/10 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0055FF]/10 dark:bg-[#00D4B2]/10 text-[#0055FF] dark:text-[#00D4B2] text-xs font-bold uppercase tracking-wider">
            <Wrench size={14} /> Trades & Work Orders Lifecycle
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-[#0055FF] hover:bg-blue-600 text-white font-bold text-xs flex items-center gap-2 shadow-sm transition-all cursor-pointer"
          >
            <Vote size={15} /> Get Quotes (Tender Job)
          </button>
          <button
            onClick={() => setShowAddVendorModal(true)}
            className="px-4 py-2.5 rounded-xl bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 font-bold text-xs flex items-center gap-2 shadow-2xs transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        <div className="bg-white dark:bg-[#0d1117] rounded-2xl p-4 md:p-5 border border-gray-200 dark:border-white/10 shadow-2xs">
          <span className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider block">Active Work Orders</span>
          <div className="text-2xl font-black text-gray-900 dark:text-white mt-1">
            {workOrders.filter(wo => wo.status !== 'completed').length}
          </div>
          <span className="text-[11px] text-blue-600 dark:text-blue-400 font-medium">Ongoing repair jobs on site</span>
        </div>

        <div className="bg-white dark:bg-[#0d1117] rounded-2xl p-4 md:p-5 border border-gray-200 dark:border-white/10 shadow-2xs">
          <span className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider block">Quotes Needing Review</span>
          <div className="text-2xl font-black text-[#0055FF] dark:text-[#00D4B2] mt-1">
            {tenderRequests.length}
          </div>
          <span className="text-[11px] text-gray-500 dark:text-gray-400 font-medium">Broken lift & repair tenders</span>
        </div>

        <div className="bg-white dark:bg-[#0d1117] rounded-2xl p-4 md:p-5 border border-amber-200 dark:border-amber-500/30 bg-amber-50/40 dark:bg-amber-950/10 shadow-2xs">
          <span className="text-[11px] font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wider block">Needs Manager Sign-Off</span>
          <div className="text-2xl font-black text-amber-600 dark:text-amber-400 mt-1">
            {workOrders.filter(wo => wo.status === 'completion_submitted').length}
          </div>
          <span className="text-[11px] text-amber-700 dark:text-amber-500 font-medium">Photos & invoice submitted</span>
        </div>

        <div className="bg-white dark:bg-[#0d1117] rounded-2xl p-4 md:p-5 border border-gray-200 dark:border-white/10 shadow-2xs">
          <span className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider block">Verified Directory</span>
          <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400 mt-1">
            {vendors.filter(v => v.insuranceStatus === 'Active').length}
          </div>
          <span className="text-[11px] text-gray-500 dark:text-gray-400 font-medium">Insured trades in directory</span>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-white/10 pb-4">
        <div className="flex items-center gap-2 p-1 bg-gray-100 dark:bg-white/5 rounded-2xl border border-gray-200/80 dark:border-white/10 w-fit">
          <button
          ...
          >
            Quote Comparisons & Tenders ({tenderRequests.length})
          ...
          >
            Verified Trades Directory ({vendors.length})
          </button>
        </div>
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input 
            ...
            className="w-full pl-9 pr-4 py-2 rounded-xl bg-white dark:bg-[#0d1117] border border-gray-200 dark:border-white/10 text-xs text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:border-[#0055FF] dark:focus:border-[#00D4B2]"
          />
          {searchQuery && (
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg text-xs font-semibold cursor-pointer flex items-center gap-1 ${
